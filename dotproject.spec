...
Oparte na PHP i WWW środowisko do zarządzania projektami zawierające
moduły dla firm, projektów, zadań (z wykresami Gantta), forum, plików,
kalendarza, kontaktów, biletów/helpdesku, obsługę wielu języków,
uprawnienia użytkowników do modułów oraz motywy.
